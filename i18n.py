...
CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "trailer": "Trailer",
        "play_here": "Play here",
        "trailer_idle": "Press f7 on a title to play its trailer here.",
        "trailer_resolving": "Finding the trailer stream...",
        "trailer_buffering": "Buffering...",
        "trailer_ended": "Trailer finished. f7 plays it again.",
        "trailer_stopped": "Stopped. f7 plays it again.",
        "trailer_missing_tools": "Trailer playback needs: {tools}",
        "open_page": "Open page",
